...
namespace Ogre_glTF
{
	/// Represent a GlbFile resource as output by the resource manager
	class GlbFile : public Ogre::Resource
	{
	...
	public:
		///Construct a resource. This is intended to be done by OgreResourceManager, not by you really
		...
		///Get the number of bytes stored. This is effectively the size of the vector
