...
namespace Ogre_glTF
{
	...
	struct glTFLoaderInterface
	{
        ...
        virtual bool createScene(const std::string& modelName, LoadFrom loadLocation,
	...
	public:
        ...
        void makeScene(Ogre::SceneManager* smgr, Ogre::SceneNode* parentNode);
	...
	public:
        ...
        bool createScene(const std::string& modelName, LoadFrom loadLocation,
